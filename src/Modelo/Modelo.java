...
public class Modelo {
    ...
    public ArrayList<Integer> lectura2(){
        try{
            File archivo = new File("C:\\Users\\RGH-LS17-16\\Documents\\archivos\\numeros.txt");
            ...
            JOptionPane.showMessageDialog(null," El archivo NO Existe en la Ruta");
            return(null);
        }        
    }
    ...
    public void orden(ArrayList<Integer> arreglo, String tipo){
        ...
        if(tipo.equals("Ascendente")){
            try{
                File ficheros = new File("C:\\Users\\RGH-LS17-16\\Documents\\archivos\\ascb.txt");             //Busca el archivo ascb
                ficheros.delete();                                                                       //Borra el archivo ascb, esto con el fin de que no se sobreescriba si se ejecuta otra vez 
                fichero = new FileWriter("C:\\Users\\RGH-LS17-16\\Documents\\archivos\\ascb.txt", true);       //Lo vuelve a crear
            ...
            try{
                File ficheros = new File("C:\\Users\\RGH-LS17-16\\Documents\\archivos\\descb.txt");             //Busca el archivo descb
                ficheros.delete();                                                                        //Borra el archivo ascb, esto con el fin de que no se sobreescriba si se ejecuta otra vez 
                fichero = new FileWriter("C:\\Users\\RGH-LS17-16\\Documents\\archivos\\descb.txt", true);       //Lo vuelve a crear
                pw = new PrintWriter(fichero);
    ...
    public void orden2(ArrayList<Integer> arreglo, String tipo){
        ...
        if(tipo.equals("Ascendente")){
            try{
                File ficheros = new File("C:\\Users\\RGH-LS17-16\\Documents\\archivos\\ascqs.txt");            //Busca el archivo ascqs
                ficheros.delete();                                                                       //Borra el archivo ascqs, esto con el fin de que no se sobreescriba si se ejecuta otra vez 
                fichero = new FileWriter("C:\\Users\\RGH-LS17-16\\Documents\\archivos\\ascqs.txt", true);      //Lo vuelve a crear
                pw = new PrintWriter(fichero);
                for(int i = 0; i < arreglo.size();  i++){
                    pw.println(arreglo.get(i));
                } 
            ...
            try{
                File ficheros = new File("C:\\Users\\RGH-LS17-16\\Documents\\archivos\\descqs.txt");            //Busca el archivo ascqs
                ficheros.delete();                                                                        //Borra el archivo ascqs, esto con el fin de que no se sobreescriba si se ejecuta otra vez 
                fichero = new FileWriter("C:\\Users\\RGH-LS17-16\\Documents\\archivos\\descqs.txt", true);      //Lo vuelve a crear
                pw = new PrintWriter(fichero);
                for(int i = arreglo.size()-1; i>=0; i--){
                    pw.println(arreglo.get(i));
                } 
