    ...
    public void actionPerformed(ActionEvent e) {                                          //Metodo para manejar eventos de acciones cuando se ejecuten los botones
        ...
        if(e.getSource() == vista.burbuja){
            ...
            if(tipo.equals("Ascendente")) {
                try {
                File objetofile = new File ("C:\\Users\\RGH-LS17-16\\Documents\\archivos\\ascb.txt");
                ...
                try {
                File objetofile = new File ("C:\\Users\\RGH-LS17-16\\Documents\\archivos\\descb.txt");
            ...
            if(tipo.equals("Ascendente")) {
                try {
                File objetofile = new File ("C:\\Users\\RGH-LS17-16\\Documents\\archivos\\ascqs.txt");
                Desktop.getDesktop().open(objetofile);                                    //Si el usuario selecciono ascendente, el archivo con los numeros ordenados se abre automaticamente
            }catch (IOException ex) {
                System.out.println(ex);
            }
                ...
                try {
                File objetofile = new File ("C:\\Users\\RGH-LS17-16\\Documents\\archivos\\descqs.txt");
